/**
 * Frontfiles Upload V4 — Empty State (D2.1 §6.2)
 *
 ...
 *
 * D2.1 ships only the visual affordance. The actual file-drop listener
 * (whole-window dragover + drop → ADD_FILES) lands in D2.7 at the
 * UploadShellV4 root level. The "click to browse" CTA is also wired
 * in D2.7. For now, this is render-only.
 */
