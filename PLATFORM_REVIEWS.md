...
- API: `/api/special-offer/route.ts`, `/api/special-offer/[id]/{accept,counter,decline}/route.ts`
...
- Diff `SPECIAL_OFFER_SPEC.md` against current `src/lib/special-offer/` and `/api/special-offer/*` implementation. Identify drift.
